...
# tạo background
bg = pygame.image.load('G:/Code game/City war/New folder/game/background.jpg').convert()
#tạo ảnh welcome game
welcome_image = pygame.image.load('G:/Code game/City war/New folder/game/welcome.png').convert_alpha()
welcome_image = pygame.transform.scale2x(welcome_image)
#tạo sàn
floor = pygame.image.load('G:/Code game/City war/New folder/game/floor.png').convert()
floor = pygame.transform.scale2x(floor)
floor_x = 0
floor_y = 480
#tạo các tòa nhà
build = pygame.image.load('G:/Code game/City war/New folder/game/building.png').convert()
...
plane = pygame.image.load('G:/Code game/City war/New folder/game/heli_enemy.png').convert_alpha()
...
heli = pygame.image.load('G:/Code game/City war/New folder/game/heli_main.png').convert_alpha()
heli_x = 100
heli_y = 200
heli_move = 0
#tạo âm thanh cho game
bg_sound = mixer.music.load('G:/Code game/City war/New folder/game/background_music.wav')
building_score = pygame.mixer.Sound('G:/Code game/City war/New folder/game/building_pass_sound.wav')
enemy_score = pygame.mixer.Sound('G:/Code game/City war/New folder/game/enemy_pass_sound.wav')
high_score_sound = pygame.mixer.Sound('G:/Code game/City war/New folder/game/highscore_sound.wav')
crash_sound = pygame.mixer.Sound('G:/Code game/City war/New folder/game/explosion_sound.wav')
#tạo font và cỡ chữ
